module.exports = class {
  ...
  async run () {
    ...
    setInterval(async () => {
      this.client.FN.listen(this.client.lastThread, this.client.channels.findf("name", "forum-notification"));
    }, 5000)
    ...
    this.client.user.setActivity(`LF2 | עזרה${this.client.settings.get("default").prefix}`);
